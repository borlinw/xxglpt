...
<div style="width:100%;">
    <div  style="height:96px;" border="false">
	    <div id="righttop">
			<div id="p_top">当前位置>&nbsp;项目管理>&nbsp;项目管理</div>
		</div>
			...
			<fieldset style="width:99%; text-align: left; vertical-align: middle;">
				...
				<div>
					<p style="margin: 1% 0px 1% 2%;">
							...
							<span>项目执行区域：</span>
							 <input class="combo-text validatebox-text" id="xmzxqy" style="width: 113px; height: 20px; line-height: 20px;" type="text">
							<span>实际完成时间：</span>
